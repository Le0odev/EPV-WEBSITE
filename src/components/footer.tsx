                ...
                <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/emporioverdegraos/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><InstagramIcon className="h-6 w-6 hover:text-foreground" /></a>
                        </div>
                    </div>
                </div>
